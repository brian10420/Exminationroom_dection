...
data_dir = r'D:\NCUE_lab\Shuffelnet_detection\Students_L_training'
...
train_loader, val_loader, test_loader, num_classes = load_datasets(data_dir)
...
model_save_path = r'D:\NCUE_lab\Shuffelnet_detection\classification_10_V1.pth'
